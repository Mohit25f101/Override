...
SYSTEM_PROMPT = (
    "You are an emergency triage AI. You are given structured emergency evidence\n"
    "synthesised from a phone's sensors, an automated rule-based risk assessment,\n"
    "and (optionally) free-text context from the caller. Your job is to extract\n"
    "all observable facts and return ONLY valid JSON.\n"
    "\n"
